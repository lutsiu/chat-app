...
export default function ChangeUsername(props: Props) {
  ...
  async function onSubmit(values: { userName: string }): Promise<void> {
    try {
      setShowPopup(false);
    } catch (err) {
      console.log(err);
          ...
          <form onSubmit={formik.handleSubmit} className="mt-[1rem] ">
            <div className="flex flex-col pt-[1rem] pr-[1rem] px-[2rem]">
              ...
              <motion.input
                ...
                animate={{
                  borderBottomColor: formik.errors.userName
                    ? pink
                    : mediumPurple,
                }}
            ...
            <div className="mt-[1.5rem] bg-gray-800 flex flex-col gap-[1rem] text-xl text-gray-400 px-[2rem] py-[1rem]">
              <p>
                ...
                without knowing your email.
              </p>
              <p>You can use a-z, 0-9 and underscores.Minimum length is 2 characters</p>
            </div>
